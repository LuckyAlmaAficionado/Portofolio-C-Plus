...
// void tambah child/pemain
void tambah_pemain(Node *node, string InName, string role)
{
    if (checkAllPlayer(InName))
    {
        cout << InName << " pemain sudah dilapangan." << endl;
    }
    else
    {
        cur = parentHead;
...
// add striker, midfielder, defender, goalkeeper
void tambah_striker(Node *node, string InName)
{
    tambah_pemain(temp, InName, "striker");
}
void tambah_midfielder(Node *node, string InName)
{
    tambah_pemain(temp, InName, "midfielder");
}
void tambah_defender(Node *node, string InName)
{
    tambah_pemain(temp, InName, "defender");
}
void tambah_goalkeeper(Node *node, string InName)
{
    tambah_pemain(temp, InName, "goalkeeper");
}

void hapus_pemain(string OutPlayer, string role)
{
    string data;
    if (checkAllPlayer(OutPlayer))
    {
...
int main()
{
    ...
    tambah_pemain(temp, "Lucky1", "striker");
    tambah_pemain(temp, "Lucky2", "striker");
    tambah_pemain(temp, "Lucky3", "striker");

    tambah_pemain(temp, "Lucky4", "defender");
    tambah_pemain(temp, "Lucky6", "defender");
    tambah_pemain(temp, "Lucky5", "defender");

    tambah_pemain(temp, "Lucky7", "midfielder");
    tambah_pemain(temp, "Lucky8", "midfielder");
    tambah_pemain(temp, "Lucky9", "midfielder");

    tambah_pemain(temp, "Lucky10", "goalkeeper");

    // hapus_pemain("lucky6", "defender");
